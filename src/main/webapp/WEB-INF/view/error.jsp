    ...
    <div class="error-page-container">
        ...
        <c:choose>
            <c:when test="${errorCode == 404}">
                ...
                <p>Пожалуйста, перейдите по актуальному адресу или вернитесь на <a class="error-link" href="/">главную страницу</a></p>
            </c:when>
            <c:when test="${errorCode == 500}">
                <h1>Возникла ошибка на стороне сервера</h1>
                <p>Пожалуйста, повторите попытку позднее или вернитесь на <a class="error-link" href="/">главную страницу</a></p>
            </c:when>
            <c:otherwise>
